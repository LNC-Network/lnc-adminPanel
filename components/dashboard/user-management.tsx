        ...
        <>
            ...
            <div className="space-y-4 sm:space-y-6 animate-fade-in">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-xs sm:text-sm">
                                    Manage users, roles, and pending registrations
                                </p>
                            </div>
                        </div>
                        <Button
                ...
                <Tabs defaultValue="users" className="space-y-4">
                    <TabsList className="w-full sm:w-auto overflow-x-auto flex justify-start no-scrollbar">
                    ...
                    <TabsContent value="users" className="space-y-4">
                        <div className="grid gap-4 grid-cols-1 xl:grid-cols-[400px_1fr]">
                            {/* Create User Form - Left Side */}
                            <Card className="h-fit border-border/40 shadow-lg">
                                <CardHeader>
                                ...
                                <CardContent>
                                    <div className="grid gap-4">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Select value={team} onValueChange={setTeam} disabled={loading || !canCreateUser}>
                                        ...
                                        <Button onClick={addUser} disabled={loading || !canCreateUser} className="w-full">
                            ...
                            <Card className="border-border/40 shadow-lg">
                                ...
                                <CardContent>
                                    <div className="rounded-lg overflow-auto max-h-[600px]">
                                        <Table>
                                            <TableHeader>
                                                <TableRow>
                                            ...
                                            {pendingUsers.length === 0 ? (
                                                ...
                                                pendingUsers.map((pending) => (
                                                    <TableRow key={pending.id}>
                                                        <TableCell className="font-medium">{pending.display_name}</TableCell>
                                                        <TableCell>{pending.email}</TableCell>
                                                        <TableCell className="hidden sm:table-cell">{pending.team}</TableCell>
                                                        <TableCell className="hidden md:table-cell">
                                                            ...
                                                            {pending.status === "pending" && (
                                                                <div className="flex justify-end gap-2">
                                                                    <Select
                                                                        ...
                                                                        onValueChange={(role) => handleApprove(pending, role)}
                                                                    >
                                                                        <SelectTrigger className="w-28 sm:w-32">
                                                                            <SelectValue
                                                                                placeholder={approvingId === pending.id ? "..." : "Approve"}
                                                                            />
                                                                        </SelectTrigger>
                                                                        <SelectContent>
                                                                            <SelectItem value="dev member">Dev Member</SelectItem>
                                                                            <SelectItem value="social media member">Social Media</SelectItem>
                                                                            <SelectItem value="content member">Content</SelectItem>
                                                                            <SelectItem value="pr & outreach member">PR & Outreach</SelectItem>
                                                                            <SelectItem value="design member">Design</SelectItem>
                                                                            <SelectItem value="dev team admin">Dev Admin</SelectItem>
                                                                            <SelectItem value="admistater">Admistater</SelectItem>
